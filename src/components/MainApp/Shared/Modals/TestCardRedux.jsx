...
function TestCardRedux({
  ...
  const handleRequestClick = () => {
    ...
    // Focus automatico dopo che il componente si ri-renderizza
    setTimeout(() => {
              ...
              <div className={styles.buttonRow}>
                ...
                {courseState.status === "waiting" && !isInstructor && (
                  <div className={styles.buttonContainer}>
                    ...
                    >
                      Accetta {getXPCosts().firstPayment} XP ora +
            ...
            {isInstructor &&
              (courseState.status === "idle" ? (
                <>
                  ...
                  <Button title="Modifica esperienza" onClick={handleEditClick}>
                    Modifica
                  </Button>
                </>
              ) : (
