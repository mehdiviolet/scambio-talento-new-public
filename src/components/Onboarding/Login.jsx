...
const Login = ({ onLoginSuccess, onRegister, onForgotPassword }) => {
  ...
  // Aggiungi questa funzione nel componente Login
  ...
  // Nel tuo Login.js, sostituisci handleSubmit con:
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // 🎯 DEMO LOGIC SEMPLICE:
      if (formData.email === "demo@app.com" && formData.password === "123456") {
        ...
        throw new Error("Usa: demo@app.com / demo123");
      }
    } catch (err) {
    ...
    <div className={styles.loginContainer}>
      <div className={styles.loginCard}>
        ...
        <div className={styles.loginForm}>
          ...
          <div className={styles.demoCredentials} onClick={handleDemoFill}>
            <small>
              <strong>Demo:</strong> email: demo@app.com, password: 123456
              <br />
